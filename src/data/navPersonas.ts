...
export const NAV_PERSONAS: Record<NavSectionId, NavPersona> = {
  home: {
    ...
    glass: 'rgba(4, 16, 24, 0.92)',
    border: 'rgba(0, 230, 255, 0.32)',
  ...
  about: {
    ...
    accent: '#93C5FD',
    accentSoft: 'rgba(147, 197, 253, 0.22)',
    ink: '#E8E2D6',
    inkMuted: 'rgba(232, 226, 214, 0.5)',
    glass: 'rgba(4, 16, 24, 0.94)',
  ...
  experience: {
    ...
    tagline: 'BLADE EDGE',
    accent: '#DF3640',
    accentSoft: 'rgba(223, 54, 64, 0.24)',
    ink: '#F3EDEA',
    inkMuted: 'rgba(243, 237, 234, 0.5)',
    glass: 'rgba(10, 2, 4, 0.95)',
    border: 'rgba(223, 54, 64, 0.4)',
  ...
  skills: {
    ...
    accent: '#C6A75E',
    accentSoft: 'rgba(198, 167, 94, 0.24)',
    ink: '#F5F0E6',
    inkMuted: 'rgba(245, 240, 230, 0.5)',
    glass: 'rgba(7, 11, 20, 0.95)',
  ...
  contact: {
    ...
    ink: '#E8E2D6',
    inkMuted: 'rgba(232, 226, 214, 0.5)',
    glass: 'rgba(8, 10, 25, 0.96)',
    border: 'rgba(223, 54, 64, 0.28)',
