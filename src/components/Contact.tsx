        ...
        <div className='grid gap-8 sm:gap-12 md:grid-cols-2'>
          ...
          >
            {[
              ...
              >
                <motion.div
                  className='bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 group-hover:from-blue-50 group-hover:to-purple-50 dark:group-hover:from-blue-900/40 dark:group-hover:to-purple-900/40 p-2.5 sm:p-3 mt-1 transition-all duration-300'
                  whileHover={{ scale: 1.1, rotate: 5 }}
                >
                  <item.icon
                    className='h-5 w-5 sm:h-6 sm:w-6 text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors'
                    aria-hidden='true'
                  />
                </motion.div>
                <div>
          ...
          >
            <div>
              ...
              <div className='flex gap-3 sm:gap-4'>
                <motion.a
                  ...
                  className='cursor-target flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-gray-900 dark:bg-gray-700 text-white rounded-full hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl'
            ...
            <motion.div
              className='bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 p-6 sm:p-8 border-l-4 border-blue-600 dark:border-purple-400 shadow-md'
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
